...
class ScriptArguments:
    ...
    dataset_name: Optional[str] = field(default="Anthropic/hh-rlhf-helpful", metadata={"help": "the dataset name"})
...
# NOTE: For HH-RLHF, typically both objectives are "Positive" (Reward).
