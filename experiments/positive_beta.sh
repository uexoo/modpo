#!/bin/bash
# Positive Beta Experiment (The User Requested "Fix")
# Hypothesis: Inverting the sign fixes the trade-off.
#
# This script runs MODPO with w=0.0 and w=1.0 using POSITIVE beta for margin.
#
...
OUTPUT_ROOT="./outputs/rq1/ultrafeedback_debug/pos_beta"
...
echo "=== MODPO Debug: Positive Beta Experiment ==="
...
for W in 0.0 1.0; do
    ...
    echo "Training w=$W with POSITIVE beta..."
    
    # Using explicit --margin_beta 0.1 (Positive)
